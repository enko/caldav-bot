...
| [0013](0013-render-the-digest-in-a-configured-timezone.md) | Render the digest in a configured timezone                                 | accepted |

0001–0006 and 0009 were backfilled from the modernization series, so the code
already reflected them when they were written; 0007, 0008, 0010, 0011, 0012 and
0013 were written together with the changes they describe.
